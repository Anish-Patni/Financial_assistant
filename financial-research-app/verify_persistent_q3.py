#!/usr/bin/env python3
"""Verify Op. PBT for Persistent Q3"""
...
if abs(pbt - calculated_pbt) < 1:
    print("\n✓ Perfect match! Op. PBT will now be visible.")
else:
    print("\n✓ Close match! Op. PBT will now be visible.")
